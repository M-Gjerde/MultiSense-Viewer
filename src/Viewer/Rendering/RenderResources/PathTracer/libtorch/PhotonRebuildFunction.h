...
public:
    ...
    static torch::Tensor forward(
        ...
        EditorPathTracerLayerUI& uiLayer,
        std::shared_ptr<Scene> scenePtr,
        std::shared_ptr<PhotonRebuild> pathTracer
    )
    {
        // =================
        ...
        // Example pseudo-code:
        // pathTracer->update(*uiLayer, scenePtr);
        ...
        // Optionally, if you want to free or not is up to how your path tracer manages memory
        // pathTracer->freeImageMemory(); // if needed
